...
const Home = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50'>
      ...
      <section className='relative overflow-hidden bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 min-h-[70vh] flex items-center'>
        ...
        <div className='relative z-10 max-w-6xl mx-auto px-4'>
          <div className='text-center mb-12'>
            <div className='inline-flex items-center gap-2 bg-gradient-to-r from-green-100 to-emerald-100 px-4 py-2 rounded-full mb-6 animate-pulse'>
              <IoSparkles className='text-green-600' />
              <span className='text-green-700 font-medium text-sm'>Sri Lanka's #1 Online Grocery Store</span>
            </div>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 max-w-5xl mx-auto px-4'>
              {[
                ...
                <div key={index} className='bg-white/90 backdrop-blur-md rounded-2xl p-4 lg:p-6 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 text-center min-h-[120px] flex flex-col justify-center'>
                  <div className='text-green-600 mb-2 flex justify-center animate-pulse'>
                    {stat.icon}
                  </div>
                  <div className='text-xl lg:text-2xl font-bold text-gray-900 mb-1 leading-tight'>{stat.value}</div>
        ...
        <div className='absolute inset-0 overflow-hidden pointer-events-none'>
          <div className='absolute -top-20 -left-20 w-40 h-40 bg-green-200 rounded-full opacity-20 animate-float'></div>
          <div className='absolute -top-10 -right-10 w-32 h-32 bg-blue-200 rounded-full opacity-20 animate-float-delayed'></div>
          <div className='absolute -bottom-20 left-1/4 w-36 h-36 bg-yellow-200 rounded-full opacity-20 animate-float'></div>
          <div className='absolute -bottom-10 -right-20 w-28 h-28 bg-pink-200 rounded-full opacity-20 animate-float-delayed'></div>
        </div>
      </section>
              ...
              loadingCategory ? (
                new Array(12).fill(null).map((c, index)=>{
                  return(
                    <div key={index+"loadingcategory"} className='group'>
                      <div className='bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-6 min-h-40 shadow-md animate-pulse hover:shadow-xl transform hover:scale-105 transition-all duration-300'>
                        <div className='bg-gray-300 w-16 h-16 mx-auto rounded-xl mb-4 animate-pulse'></div>
                        <div className='bg-gray-300 h-6 rounded-lg animate-pulse'></div>
                      </div>
                    </div>
                  )
                })
                ...
                categoryData.map((cat, index)=>{
                  return(
                    ...
                    >
                      <div className='bg-white rounded-2xl p-4 min-h-40 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-green-200'>
                        ...
                        <h3 className='text-sm font-medium text-gray-900 text-center group-hover:text-green-600 transition-colors duration-300'>
                          {cat.name}
                        </h3>
                      </div>
                    </div>
        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
            {[
              ...
              <div 
                key={index} 
                className={`group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500 animate-fade-in-up border hover:border-green-200 :border-green-400`}
