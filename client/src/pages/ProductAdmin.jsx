      ...
      <div className='bg-white shadow-lg border-b border-gray-200'>
        <div className='px-6 py-4'>
          <div className='flex items-center justify-between gap-4'>
            ...
            {/* Search Bar */}
            <div className='flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-2 border border-gray-200 min-w-80 max-w-md w-full focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all duration-200'>
                    ...
                    <button 
                      ...
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 ${
                        page === 1 
                          ...
                          : 'bg-indigo-50 text-indigo-700 hover:bg-indigo-100 :bg-indigo-900/50 border border-indigo-200 '
                      }`}
                    >
