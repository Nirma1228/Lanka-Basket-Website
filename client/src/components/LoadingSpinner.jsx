...
export const PageLoader = ({ message = 'Loading...' }) => (
  <div className='fixed inset-0 bg-white/80 backdrop-blur-sm z-[80] flex items-center justify-center'>
    <div className='bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center gap-4 border'>
...
export const ListLoader = ({ items = 3 }) => (
  <div className='space-y-4'>
    {Array.from({ length: items }).map((_, index) => (
      <div key={index} className='bg-white rounded-xl p-4 border animate-pulse'>
